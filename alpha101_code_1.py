...
class AlphasSingleStock(object):
    def __init__(self, df_data):
        ...
        self.returns = (df_data['close']/df_data['prev_close']-1)*100
        self.vwap = (df_data['total_turnover']*1000)/(df_data['volume']*100+1) 
